# rag_pipeline.py - COMPLETE OPTIMIZED VERSION
...
#     if not reference:
#         # No reference available: score all as zero.
#         return {"standard": 0, "hierarchical": 0, "graph": 0, "best": None}
#     scores = {}
#     for strat in ["standard", "hierarchical", "graph"]:
#         cand = results.get(strat, {}).get("response") or ""
#         scores[strat] = openai_similarity_score(cand, reference)
